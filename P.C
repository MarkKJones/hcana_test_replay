...
void PeterB(Int_t runNumber, Int_t targ=1){
  ...
  // Skim file 
  TString fileNameSkim = "/w/hallc-scifs17exp/c-sidis18/bosted/Skimfiles//Skim" ;
  ...
  // /w/hallc-scifs17exp/c-sidis18/bosted/ROOTfiles
  ...
  Double_t  hdchit1,hdchit2,pdchit1,pdchit2,pntrk,hntrk ;
  Double_t  hdccomb1,hdccomb2,pdccomb1,pdccomb2 ;
  ...
  tt->SetBranchAddress("P.dc.Ch1.ncombos", &pdccomb1); 
  tt->SetBranchAddress("P.dc.Ch2.ncombos", &pdccomb2); 
  ...
  tt->SetBranchAddress("H.dc.Ch1.ncombos", &hdccomb1); 
  tt->SetBranchAddress("H.dc.Ch2.ncombos", &hdccomb2); 
  ...
  for (int kk=0; kk<20000;  kk++){
    ...
    if (kk % 1000 == 0 && pdelta<1000 && hdelta<1000) 
printf("%d %8.2f %8.2f %8.2f %8.2f %8.2f %8.2f %8.2f \n",
       kk, prf,hrf, hdelta, pdelta, pcaltot, hntrk, pntrk) ;  
...
//	   hdcx,hdcxp,hdcy,hdcyp,pdcx,pdcxp,pdcy,pdcyp,prf,hrf,
//	     PhodfpHitsTime,HhodfpHitsTime,pztar,hztar) ; 
//	     fprintf(f2," %3d %3d %3d %3d \n",
//	     hdcnhit1,hdcnhit2,pdcnhit1,pdcnhit2) ;
